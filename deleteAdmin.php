<?php
        ...
        try {
            ...
            if (isset($_POST['add_list'])) {
                ...
                $list_id = $_POST['isAdmin'];
                $list = new User();
                $list->deleteAdmin($list_id);
            }
...
<h1 class="header">Delete an admin 1</h1>
   ...
   <div class="error-popup"><?php if (isset($error)) {
    ...
    <button class="submitbutton" type="submit" name="delete_list">Delete Admin</button>
    <?php endforeach; ?>
